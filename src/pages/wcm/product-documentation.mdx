...
For more information, see the [April 2023 release notes](/pdf/wcm/WatsonCareManager_ReleaseNotes_April2023.pdf) on the release notes page.

For updated documentation, see the following PDF addendum:

* [Watson Care Manager April 2023 documentation](/pdf/wcm/WatsonCareManager_April2023_PDF.pdf)

You can also download the REST API Swagger documentation [JSON files](/json/wcm/IntegratedCare_JSON.zip).
